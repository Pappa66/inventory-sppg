          ...
          <div className="card-soft overflow-hidden">
            <div className="px-5 py-3 border-b border-[#EAE4D8] bg-[#F9F6F0] flex flex-wrap justify-between items-center gap-2">
              ...
              <div className="flex flex-wrap gap-2 text-sm">
                ...
                <span>Saldo: <span className={`font-bold ${(() => { const isCost = ["BAHAN_BAKU","OPERASIONAL","FASILITAS"].includes(activeTab); const saldo = isCost ? totals.credit - totals.debit : totals.debit - totals.credit; return saldo >= 0 ? "text-[#4A7C59]" : "text-[#C5533B]"; })()}`}>{fmtIDR((() => { const isCost = ["BAHAN_BAKU","OPERASIONAL","FASILITAS"].includes(activeTab); return isCost ? totals.credit - totals.debit : totals.debit - totals.credit; })())}</span></span>
              </div>
            </div>
