  ...
  return (
    <Layout>
      <div className="space-y-6">
        ...
        {/* Logo */}
        <div className="card-soft p-6 max-w-lg">
          ...
          <p className="text-xs text-[#5C5C5C] mt-3">Logo akan tampil di semua laporan PDF.</p>
        </div>

        {/* Informasi SPPG (from Excel Setup sheet) */}
        <div className="card-soft p-6 max-w-lg">
        ...
        <div className="card-soft p-6 max-w-lg">
          ...
          <label className="text-xs uppercase tracking-widest text-[#5C5C5C] mt-3 block">Yayasan</label>
        ...
        <div className="card-soft p-6 max-w-lg">
          ...
          <label className="text-xs uppercase tracking-widest text-[#5C5C5C]">Harga Kelompok 1: Balita / PAUD / SD 1-3 (Rp)</label>
          ...
          <label className="text-xs uppercase tracking-widest text-[#5C5C5C] mt-3 block">Harga Kelompok 2: SD 4-6 / SMP / SMA / SLB / Santri / Pend / Bumil / Busui (Rp)</label>
          ...
          <label className="text-xs uppercase tracking-widest text-[#5C5C5C] mt-3 block">Jumlah Penerima Manfaat (opsional, referensi)</label>
          <textarea rows={3} className="w-full mt-1 px-4 py-2.5 rounded-md border border-[#EAE4D8] bg-[#F9F6F0] text-sm" value={settings.beneficiaries} onChange={(e)=>setSettings(p=>({...p, beneficiaries:e.target.value}))} placeholder="Contoh: Balita 50, PAUD 200, SD1-3 150, SD4-6 120, SMP 80, SMA 60, Bumil 15, Busui 10"/>
        </div>
