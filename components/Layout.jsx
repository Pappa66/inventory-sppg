...
const ALL_NAV = [
  ...
  { to: "/inventory", label: "Stok & Opname", icon: Boxes, roles: ["admin_apps","admin_sppg","field_assistant","kitchen_head","head_chef","persiapan","tenaga_masak"] },
  ...
  { to: "/procurement", label: "Belanja & Struk", icon: ShoppingBasket, roles: ["admin_apps","admin_sppg","field_assistant","accountant"] },
  { divider: true, label: "Dapur & Menu", roles: ["admin_apps","admin_sppg","head_chef","kitchen_head","nutritionist"] },
  ...
  { divider: true, label: "Pengiriman", roles: ["admin_apps","admin_sppg","field_assistant","driver"] },
  ...
  { divider: true, label: "Laporan & Approval", roles: ["admin_apps","admin_sppg","nutritionist","accountant","kitchen_head","head_chef"] },
  { to: "/dafnom", label: "DafNom Insentif", icon: Users, roles: ["admin_apps","admin_sppg","accountant","kitchen_head"] },
  { to: "/approval", label: "Persetujuan Menu", icon: BadgeCheck, roles: ["admin_apps","admin_sppg","kitchen_head","nutritionist","head_chef"] },
  { to: "/reports", label: "Laporan", icon: FileText, roles: ["admin_apps","admin_sppg","kitchen_head","head_chef","accountant","nutritionist"] },
